...
import ShadeImg from "@/public/assets/images/background/card-shade.jpeg";
  ...
  return (
    <div className="w-full h-auto min-h-[427px] gap-[70px] bg-[#1e36ea] rounded-[10px] flex-col justify-between items-start flex relative overflow-hidden pt-10 px-[25px] pb-5 shadow-md">
      ...
      <div className="w-full flex justify-between items-center">
        ...
        <HeadingAnimatedSvg animated text="LEARN MORE ABOUT ZAIN UL ABIDEEN" />
      </div>
      {/*Menu*/}
      <div className="z-40 flex flex-col gap-y-[5px] justify-center items-start relative">
        {myLinks.map((link, i) => (
            <Link 
            key={i}
            href={link.link}
