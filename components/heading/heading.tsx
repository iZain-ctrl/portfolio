...
const Heading: FC<HeadingProps> = ({ number, title_1, title_2 }) => {
    return (
      ...
      {/*Number*/}
      <div className="outline-none flex flex-col justify-start shrink-0 opacity-5 transform -top-32 2x1:top-24 w-[71px] flex-none h-auto left-4 lg:left-12 absolute whitespace-pre">
      ...
      <div className="flex items-center flex-nowrap min-h-min overflow-hidden p-0 w-full font-Oswald">
        ...
        <HeadingAnimatedSvg text="SCROLL DOWN TO LEARN MORE"/>
